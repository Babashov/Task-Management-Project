<template>
  <div class="relative p-2 flex overflow-x-auto h-full defaultTaskList">
    <!-- Columns (Statuses) -->
    <div
      v-for="status in statuses"
      :key="status.slug"
      class="mr-6 w-4/5 max-w-xs flex-shrink-0 defaultTaskList"
      style="overflow-y:scroll;height:400px;"
    >
      <div class="rounded-md shadow-md overflow-hidden bg-gray-100">
        <div class="p-3 flex justify-between items-baseline">
          ...
          <button
            ...
            class="py-1 px-2"
            style="display: flex;justify-content: center;align-items: center;color: #5f8ff5;background-color: #c5d5f7;width: 30px;height: 30px;
    cursor: pointer;
    border-radius: 50%;"
          >
            +
